-- ============================================================================
-- FIX NEAR POINT FUNCTION GEOGRAPHY TYPE ERROR
-- ============================================================================
-- Fixes the get_walking_experiences_near_point function to avoid geography type
-- casting issues with SET search_path = ''
-- The function uses ST_DWithin which works with geography, but we need to avoid
-- explicit ::geography casts in the WHERE clause
