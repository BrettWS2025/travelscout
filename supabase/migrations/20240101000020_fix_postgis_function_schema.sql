-- ============================================================================
-- Fix: Correct PostGIS function schema qualification
-- ============================================================================
-- Purpose: Fix ST_MakePoint and ST_SetSRID to use the correct schema (extensions)
-- when using SET search_path = ''

-- Update the populate_places_from_linz function to use extensions.ST_MakePoint and extensions.ST_SetSRID
