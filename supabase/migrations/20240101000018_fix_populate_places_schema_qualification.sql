-- ============================================================================
-- Fix: Add schema qualification for tables in populate_places_from_linz
-- ============================================================================
-- Purpose: Fix the populate_places_from_linz function to properly qualify
-- table names with public. schema when using SET search_path = ''

-- Update the populate_places_from_linz function with schema qualification
