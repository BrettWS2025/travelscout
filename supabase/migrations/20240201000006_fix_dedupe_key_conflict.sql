-- ============================================================================
-- FIX DEDUPE_KEY CONFLICT IN rebuild_nz_places_final
-- ============================================================================
-- Purpose: Fix duplicate dedupe_key violations by using DISTINCT ON
-- When multiple places have the same dedupe_key, keep only one
-- (prefer the one with admin area info)
--
-- This migration updates the rebuild function to handle duplicate dedupe_keys
-- that can occur when multiple OSM entities share the same name and location
