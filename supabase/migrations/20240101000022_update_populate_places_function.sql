-- ============================================================================
-- Update populate_places_from_linz function to final corrected version
-- ============================================================================
-- Purpose: Migration 17 was updated after being applied, so we need a new
-- migration to update the function to the correct version with all fixes:
-- - POLYGON geometry support
-- - Proper schema qualifications (public., extensions.)
-- - Correct UUID and PostGIS function calls
