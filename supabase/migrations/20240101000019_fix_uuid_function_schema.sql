-- ============================================================================
-- Fix: Correct UUID function schema qualification
-- ============================================================================
-- Purpose: Fix uuid_generate_v4() to use the correct schema (extensions)
-- when using SET search_path = ''

-- Update the populate_places_from_linz function to use extensions.uuid_generate_v4()
