...
export function useTripPlanner() {
  ...
  return {
    ...
    addViatorProductToDay: plan.addViatorProductToDay,
    removeViatorProductFromDay: plan.removeViatorProductFromDay,
    addManualTripEntry: plan.addManualTripEntry,
    removeManualTripEntry: plan.removeManualTripEntry,
    updateManualTripEntry: plan.updateManualTripEntry,
