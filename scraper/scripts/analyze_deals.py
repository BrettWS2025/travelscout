...
USER_PROMPT_CORE = (
    ...
    "Only if the travel agency deal is cheaper than the Do it yourself version, then i want the travel agency deal to be highlighted as one of the top 10 deals"
    "For example if the total cost of a twin share through a travel agency is $10000 but doing it yourself costs $8000, then i don't want to know about that deal."
    "However if a travel agency deal costs $10000 for 2 people ($5000 each) and the DIY version costs $12000 ($6000 each) then that is what should be in teh top 10 deals."
