...
import { HeroOperatorSignup } from "@/components/home/HeroOperatorSignup";
      ...
      <section className="relative min-h-[100svh] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-[100svh] flex-col items-center justify-center px-5 pb-20 pt-28 md:px-10 md:pb-24 lg:px-16">
          <div className="w-full max-w-xl animate-hero-rise text-center">
            <h1 className="mb-8 font-[family-name:var(--font-instrument)] text-3xl leading-tight tracking-tight text-white md:text-4xl lg:text-[2.75rem]">
              You&apos;re operating anyway, why not sell those last few seats for
              pure profit?
            </h1>
            <HeroOperatorSignup />
          </div>
