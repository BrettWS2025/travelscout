    ...
    <header className="sticky top-0 z-50 backdrop-blur bg-[var(--bg)]/70 border-b border-white/10">
      <div className="container flex items-center justify-between py-4">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link href="/(product)/compare" className="hover:text-[var(--accent)] flex items-center gap-2"><PanelsTopLeft className="w-4 h-4" />Compare</Link>
          <Link href="/(marketing)/guides" className="hover:text-[var(--accent)] flex items-center gap-2"><Compass className="w-4 h-4" />Guides</Link>
          <Link href="/(marketing)/deals" className="hover:text-[var(--accent)] flex items-center gap-2"><Percent className="w-4 h-4" />Deals</Link>
        </nav>
