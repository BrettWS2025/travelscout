...
<article className="space-y-6" style={{ color: "var(--text)" }}>
  ...
  <p style={{ color: "var(--muted)" }}>
    This guide seeks to give you as much information as possible before
  ...
  <section className="space-y-4">
    ...
    <div className="space-y-2">
      ...
      <p style={{ color: "var(--muted)" }}>
        A travel agency or travel agent can go by many names—Travel Adviser,
        Consultant, Broker, Agent, or Expert. A typical travel agent is a travel
        specialist with broad access to most travel options you can think of.
      </p>
    </div>
    ...
    <div className="space-y-2">
      ...
      <p style={{ color: "var(--muted)" }}>
        An OTA is an online service that lets you browse live inventory across
        flights, hotels, cars, cruises, attractions, and more. Examples include
    ...
    <div className="space-y-2">
      ...
      <p style={{ color: "var(--muted)" }}>
        Direct booking is when you book with the supplier—e.g., the Air New
        Zealand website or a hotel’s own site.
      </p>
    </div>
  </section>
    ...
    <div className="space-y-2">
      ...
      <div className="grid gap-2 md:grid-cols-2">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              Limited access to some airline product types (e.g., Air NZ’s
              Seat-only/Seat+Bag)
            </li>
      ...
      <div className="grid gap-2 md:grid-cols-2">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Some suppliers don’t cater to NZ time zones; support can be hard
              to reach
            </li>
          </ul>
        </div>
  ...
  <section className="space-y-2">
    ...
    <p style={{ color: "var(--muted)" }}>
      These are <strong>metasearch</strong> tools: they aggregate pricing and
      availability from across the internet to show options, then redirect you
      elsewhere to complete the booking. They’re super handy, but be{" "}
      <em>wary</em>—they can sometimes point you to less-trustworthy sellers.
      They also don’t account for airlines with multiple product types (e.g.,
      baggage-inclusive fares vs. seat-only), so the “lowest price” shown may be
      misleading if you need baggage that’s already included with a different
      airline.
    </p>
  </section>
</article>
